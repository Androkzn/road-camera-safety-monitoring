---
description: Stop the road-safety app running on port 8001
---
...
1. Find the process(es) listening on port 8001:
...
Notes:
- Be careful not to kill unrelated processes. Only act on PIDs bound to port 8001.
